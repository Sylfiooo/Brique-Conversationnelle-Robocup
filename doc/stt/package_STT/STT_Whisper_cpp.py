...
from stt.package_STT.STT_Whisper_Cpp_Binder import *
import ctypes
...
class STT_Whisper_cpp :
    ...
    def __init__ (self):
        self.args = [ctypes.c_char_p(b"stream"), ctypes.c_char_p(b"-m"), ctypes.c_char_p("./stt/package_STT/ggml-base.en.bin".encode('utf-8')), 
