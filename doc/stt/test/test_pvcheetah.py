...
def main():
    ...
    o = create(
        access_key="LdmOA3RGnnwERJjUh4GsPtykpvO0d2UbXbK6uNkxsdWIUB4+Hk4ASA==t",
    ...
    audio = AudioSegment.from_file("test/fichier_audio_input/english_test.wav", format="wav")
    audio = audio.set_channels(1).set_frame_rate(16000).set_sample_width(2)
    audio.export("test/audio_convert/convert_bis.wav", format="wav")

    try:
        for wav_path in ["test/audio_convert/convert_bis.wav"]:
